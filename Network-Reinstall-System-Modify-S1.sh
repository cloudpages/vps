...
if [ $1 = '-CentOS_7' ]
then
	wget --no-check-certificate -qO koiok.sh 'https://d.tedx.net/vps/koiok.sh' && bash koiok.sh -dd 'http://hk.tedx.net/_old_/dl/CentOS_7.X_NetInstall_AutoPartition.vhd.gz'
fi
...
then
	wget --no-check-certificate -qO koiok.sh 'https://d.tedx.net/vps/koiok.sh' && bash koiok.sh -dd 'http://hk.tedx.net/_old_/dl/Disk_Windows_Server_2003_DataCenter_CN.vhd.gz'
fi

if [ $1 = '-Windows_7_Vienna' ]
then
	wget --no-check-certificate -qO koiok.sh 'https://d.tedx.net/vps/koiok.sh' && bash koiok.sh -dd 'http://hk.tedx.net/_old_/dl/Disk_Windows_7_Vienna_Ultimate_CN.vhd.gz'
fi

if [ $1 = '-Windows_Server_2008R2' ]
then
	wget --no-check-certificate -qO koiok.sh 'https://d.tedx.net/vps/koiok.sh' && bash koiok.sh -dd 'http://hk.tedx.net/_old_/dl/Disk_Windows_Server_2008R2_DataCenter_CN.vhd.gz'
fi

if [ $1 = '-Windows_Server_2012R2' ]
then
	wget --no-check-certificate -qO koiok.sh 'https://d.tedx.net/vps/koiok.sh' && bash koiok.sh -dd 'http://hk.tedx.net/_old_/dl/Disk_Windows_Server_2012R2_DataCenter_CN.vhd.gz'
fi

if [ $1 = '-Windows_Server_2016' ]
then
	wget --no-check-certificate -qO koiok.sh 'https://d.tedx.net/vps/koiok.sh' && bash koiok.sh -dd 'http://hk.tedx.net/_old_/dl/Disk_Windows_Server_2016_DataCenter_CN.vhd.gz'
fi

if [ $1 = '-Windows_Server_2019' ]
then
	wget --no-check-certificate -qO koiok.sh 'https://d.tedx.net/vps/koiok.sh' && bash koiok.sh -dd 'http://hk.tedx.net/_old_/dl/Disk_Windows_Server_2019_DataCenter_CN.vhd.gz'
fi
